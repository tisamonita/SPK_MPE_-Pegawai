...
$query1 = "SELECT * FROM penilai where id_user='$id_user'";
$link1 = mysqli_query($link, $query1);
$data1 = mysqli_fetch_array($link1);
...
<section>
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="user-info">
            <div class="image">
                <img src="<?=$data1['foto']; ?>" width="48" height="48" alt="User" />
            </div>
            <div class="info-container">
                <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?= $data1['nama']; ?></div>
        ...
        <div class="menu">
            <ul class="list">
                ...
                <li <?php if($_GET['module'] == 'user' || $_GET['module'] == '' || $_GET['module'] == '') { ?> class="active" <?php } else { ?> class="nav-item" <?php } ?>>
                    <a href="?module=user">
                        <i class="material-icons">account_box</i>
                        <span>User</span>
                    </a>
                </li>
                <li <?php if($_GET['module'] == 'pegawai' || $_GET['module'] == '' || $_GET['module'] == '') { ?> class="active" <?php } else { ?> class="nav-item" <?php } ?>>
                    <a href="?module=pegawai">
                        <i class="material-icons">supervisor_account</i>
                        <span>Pegawai</span>
                    </a>
                </li>
                <li <?php if($_GET['module'] == 'kriteria' || $_GET['module'] == '' || $_GET['module'] == '') { ?> class="active" <?php } else { ?> class="nav-item" <?php } ?>>
                    <a href="?module=kriteria">
                        <i class="material-icons">assignment</i>
                        <span>Kriteria</span>
                    </a>
                </li>
                <li <?php if($_GET['module'] == 'hasil' || $_GET['module'] == '' || $_GET['module'] == '') { ?> class="active" <?php } else { ?> class="nav-item" <?php } ?>>
                    <a href="?module=hasil">
                        <i class="material-icons">text_fields</i>
                        <span>Hasil</span>
                    </a>
                </li>
                <li <?php if($_GET['module'] == 'keputusan' || $_GET['module'] == 'keputusan3' || $_GET['module'] == '') { ?> class="active" <?php } else { ?> class="nav-item" <?php } ?>>
                    <a href="?module=keputusan">
                        <i class="material-icons">layers</i>
                        <span>Keputusan</span>
                    </a>
                </li>  
                <li <?php if($_GET['module'] == 'history' || $_GET['module'] == '' || $_GET['module'] == '') { ?> class="active" <?php } else { ?> class="nav-item" <?php } ?>>
...
<section class="content">
    <div class="container-fluid">
        <?php require_once('admin/'.$_GET['module'].'.php'); ?>
    </div>
</section>
