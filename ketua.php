        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li <?php if($_GET['module'] == 'home2' || $_GET['module'] == '' || $_GET['module'] == '') { ?> class="active" <?php } else { ?> class="nav-item" <?php } ?> >
                        <a href="?module=home">
                    ...
                    <li <?php if($_GET['module'] == 'nilai' || $_GET['module'] == 'isian'|| $_GET['module'] == 'ubahisian'  || $_GET['module'] == 'nilai_pegawai'|| $_GET['module'] == '') { ?> class="active" <?php } else { ?> class="nav-item" <?php } ?>>
                     ...
                     <li <?php if($_GET['module'] == 'keputusan' || $_GET['module'] == 'keputusanselesai'|| $_GET['module'] == 'keputusan3'  || $_GET['module'] == ''|| $_GET['module'] == '') { ?> class="active" <?php } else { ?> class="nav-item" <?php } ?>>
