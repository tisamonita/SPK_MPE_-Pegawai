...
if ($_POST['ubah']){
    ...
    $query2 = "UPDATE penilai set nama='$nama', jabatan='$jabatan', email='$email' WHERE id_user='$id_user'";
    $hasil2 = mysqli_query($link, $query2);
        ...
        <div class="card profile-card">
            ...
            <div class="profile-body">
                <div class="image-area">
                    <img src="<?= $hasil01['foto']; ?>" width="200px" alt="Profile Image" />
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="defaultModalLabel">Ubah Data Akun</h4>
            </div>
                            ...
                            <div class="body">
                                <form method="POST">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="nama" class="form-control" value="<?= $hasil01['nama']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="jabatan" class="form-control" value="<?= $hasil01['jabatan']; ?>">
                                        </div>
                                    </div>
                                       <label for="email_address">Email</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="email" name="email" class="form-control" value="<?= $hasil01['email']; ?>">
                                        </div>
                                    </div>
